...
class HookServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        add_action(BASE_ACTION_PUBLIC_RENDER_SINGLE, [$this, 'checkPublishDateBeforeShowSingle'], 130, 2);
    }
    ...
    function checkPublishDateBeforeShowSingle(string $screen, $post)
    {
        if (PostScheduler::isSupportedModule(get_class($post)) && $post->created_at > Carbon::now()) {
            return abort(404);
        }
    }
